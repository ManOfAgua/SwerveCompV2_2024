...
public class arm extends SubsystemBase {      
  ...
  private final ArmFeedforward feedForward = new ArmFeedforward(0, 0, 0); /*  Volts, volts, volts * (seconds/radians), 
                                                                              (volts * seconds^2) / radians   Last one for ka */
  ...
  public void brakeMode(){
    ...
    /*  public double calculateAngle(){
        ...
        if(hasTargets && (targetID == 7 || targetID == 4)){
            ...
            double angle = Units.radiansToDegrees(Radangle);
