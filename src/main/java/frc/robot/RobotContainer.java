...
public class RobotContainer {
 ...
 // My joystick
  ...
  private final CommandSwerveDrivetrain drivetrain = TunerConstants.DriveTrain; // My drivetrain
                              ...
                              /* Driver Buttons */
  private final JoystickButton L1 = new JoystickButton(driver, ControllerConstants.b_L1);
  private final JoystickButton L2 = new JoystickButton(driver, ControllerConstants.b_L2);
  private final JoystickButton tri = new JoystickButton(driver, ControllerConstants.b_TRI);
  ...
  private final intake intakeSub = new intake();
                              ...
                              /* Commands */
  private final ManualArmCommand armCommand = new ManualArmCommand(operator::getLeftY, armSub);
  private final ShooterCommand shootCommand = new ShooterCommand(0.2, shooterSub);
  private final IntakeCommand intakeCommand = new IntakeCommand(0.2, intakeSub);
  ...
  private void configureBindings() {
    ...
    L2.whileTrue(drivetrain.applyRequest(() -> brake));
    tri.whileTrue(drivetrain
        .applyRequest(() -> point.withModuleDirection(new Rotation2d(-driver.getLeftY(), -driver.getLeftX()))));

    // reset the field-centric heading on left bumper press
    L1.onTrue(drivetrain.runOnce(() -> drivetrain.seedFieldRelative()));
