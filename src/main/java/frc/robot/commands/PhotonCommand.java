...
//   public PhotonCommand(DoubleSupplier setPoint, arm arm) {
//     this.armSub = arm;
//     this.goal = setPoint;
...
//     armPID.setSetpoint(goal.getAsDouble());
//     armPID.reset();
...
//     double speed = armPID.calculate(armSub.armTickToDegrees(), goal.getAsDouble());
//     armSub.move(-speed);
